...
export default function EditUserPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/dashboard/users/update', {
        method: 'POST',
      ...
      router.push('/dashboard/utilizadores');
    } catch (err: any) {
    ...
    <div className="p-6 text-[#2c3338] max-w-[900px]">
      ...
      <form onSubmit={handleSave}>
        ...
        <div className="mt-6 flex items-center gap-3">
          ...
          <Link href="/dashboard/utilizadores" className="h-9 px-4 flex items-center text-[13px] text-[#50575e] hover:text-[#135e96]">
            Cancelar
          </Link>
        </div>
      </form>

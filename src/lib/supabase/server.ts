...
/** Cliente com service role — obrigatório para login e gestão de perfis (ignora RLS). */
...
export function hasSupabaseServiceRole(): boolean {
  return Boolean(
    process.env.NEXT_PUBLIC_SUPABASE_URL && process.env.SUPABASE_SERVICE_ROLE_KEY?.trim(),
  );
}

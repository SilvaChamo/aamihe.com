...
export const boardPresident: BoardMember = {
  ...
  image: siteGalleryImage('/gallery/Vice-President-Anglophone-Rosemary-1-300x261.jpg'),
...
export const boardMembers: BoardMember[] = [
  {
    ...
    image: siteGalleryImage('/gallery/3-Tiago-Caungo-Mutombo-Vice-President-Lusophone-compressed-scaled-600x522.jpg'),
    language: { pt: 'Português', en: 'Portuguese', fr: 'Portugais' },
  },
  {
    name: 'René Gnalega',
    role: { pt: 'Vice-Presidente', en: 'Vice-President', fr: 'Vice-Président' },
    image: siteGalleryImage('/gallery/4-Rene-Gnalega-Vice-President-Francophone-compressed-scaled-600x522.jpg'),
  ...
  },
  {
    ...
    image: siteGalleryImage('/gallery/5-Yar-Donlah-Gonway-Gono-Vice-President-Anglophone-compressed-scaled-600x522.jpg'),
    language: { pt: 'Inglês', en: 'English', fr: 'Anglais' },
  },
  {
    name: 'Peter Mageto',
    role: { pt: 'Secretário', en: 'Secretary', fr: 'Secrétaire' },
    image: siteGalleryImage('/gallery/6-Peter-Mageto-Secretary-compressed-scaled-600x522.jpg'),
  },
  {
    name: 'Jamisse Taimo',
    role: { pt: 'Director Executivo', en: 'Executive Officer', fr: 'Directeur Exécutif' },
    image: siteGalleryImage('/gallery/7-Jamisse-Taimo-Consultants-Executive-Officer-compressed-scaled-600x522.jpg'),
  },
  {
    name: 'Tukumbi Lumumba',
    role: { pt: 'Consultor', en: 'Consultant', fr: 'Consultant' },
    image: siteGalleryImage('/gallery/9-Tukumbi-Lumumba-Kasongo-Consultants-compressed-scaled-600x522.jpg'),
  },
];
